var sql = {
    ...
    sql_updateItem: "UPDATE Items SET title=$1, description=$2, price=$3, catname=$4, loanstart=$5, loanend=$6, location=$7 WHERE itemid=$8",
    sql_updateImage: "UPDATE Images SET imgurl=$1 WHERE itemid = $2 and imgno = $3",
